...
class Memory(object):
    def __init__(self, limit, action_shape, observation_shape):
        ...
        self.actions = RingBuffer(limit, shape=action_shape, dtype=np.uint8)
        self.rewards = RingBuffer(limit, shape=(1,), dtype=np.int8)
        self.terminals1 = RingBuffer(limit, shape=(1,), dtype=np.bool)
    ...
    def sample(self, batch_size):
        ...
        return obs0_batch, action_batch, obs1_batch, reward_batch, terminal1_batch
